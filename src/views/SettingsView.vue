...
import { type Gender, HUNGARIAN_ALPHABET, useNameStore } from '../stores/name';
...
<template>
    <div class="flex flex-col h-full max-w-lg mx-auto w-full p-3 sm:p-4 overflow-y-auto">
        ...
        <section class="mb-8">
            ...
            <p class="text-xs text-text-secondary mt-2 px-2">
                Ez a beállítás határozza meg, melyik nem legyen kiválasztva az app indításakor.
            </p>
        </section>
        ...
        <section class="mb-8">
            ...
            <div class="bg-card rounded-xl shadow-sm p-4">
                <p class="text-sm font-medium mb-3 text-text-primary">
                    Csak ezekkel a betűkkel kezdődő nevek:
                </p>
                ...
                <div class="flex gap-3 pt-2 border-t border-gray-5">
                    <button
                        ...
                        @click="store.toggleLetterFilter('ALL')"
                    >
                        Mind
                    </button>
                    <button
                        class="text-sm text-text-secondary font-medium"
                        @click="store.toggleLetterFilter('NONE')"
                    >
                        Egyik sem
                    </button>
                </div>
            ...
            <p class="text-xs text-text-secondary mt-2 px-2">
                Ha nincs kiválasztva egy betű sem, minden név megjelenik.
            </p>
        </section>
        ...
        <!-- Danger Zone -->
        <section class="mb-8">
            <h2 class="text-sm font-semibold text-red-500 uppercase tracking-wider mb-3">
                Veszélyzóna
            </h2>
            <div class="bg-red-50 dark:bg-red-900/20 rounded-xl border border-red-100 dark:border-red-900/50 p-4">
                ...
                <p class="text-xs text-red-400 mt-2 text-center">
                    Az összes szavazat törlődik és újrakezdheted a választást.
                </p>
            </div>
        </section>
        ...
        >
            <div class="bg-card rounded-2xl shadow-xl max-w-sm w-full p-6 animate-scale-in">
                ...
                <p class="text-text-secondary mb-6">
                    Biztosan törölni szeretnéd az összes szavazatot? Ez a művelet nem vonható vissza.
                </p>
